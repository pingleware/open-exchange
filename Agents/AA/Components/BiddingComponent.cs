...
namespace OPEX.Agents.AA.Components
{
    class BiddingComponent
    {
        ...
        private readonly PriceDelegate InnerPrice;
        ...
        public BiddingComponent(AAAgent agent, OrderSide side, double limitPrice, Instrument instrument)
        {
        ...
        {
            _limitPrice = limitPrice;
            _logger.Trace(LogLevel.Info, "UpdateLimitPrice. New limit price: {0}", _limitPrice);
        }
