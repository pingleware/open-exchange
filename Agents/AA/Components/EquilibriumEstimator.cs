...
namespace OPEX.Agents.AA.Components
{
    ...
    {
        private readonly double InitialPriceGuessPercentageAroundMid = 0.35;
        ...
        public EquilibriumEstimator(AAAgent agent)
        {
        ...
        public void Reset()
        {
            ...
            double b = _agent.AgentStatus.CurrentInstrument.MaxPrice;
            ...
            int totalTicks = (int)(_estimatedPrice / _agent.AgentStatus.CurrentInstrument.PriceTick);
            _estimatedPrice = (double)totalTicks * _agent.AgentStatus.CurrentInstrument.PriceTick;            
