...
{
    public class SessionStimulusQueue : StimulusQueue
    {
        public SessionStimulusQueue(string queueName)
            : base(queueName, StimulusType.Session)
        { }
        ...
        {
            Enqueue(new SessionStimulus(sessionState));
        }
    }
}
