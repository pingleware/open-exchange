...
{
    public class NewOrderStimulus : Stimulus
    {
        private AssignmentBatch _assignmentBatch;
        private bool _newSimulationStarted;

        public NewOrderStimulus(AssignmentBatch assignment, bool newSimulationStarted)
            : base(StimulusType.NewOrder, 1)
        {
            _assignmentBatch = assignment;
