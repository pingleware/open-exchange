...
namespace OPEX.Storage
{
    ...
    public partial class DBWriter    
    {
        protected class CommandBuilder
        {
            ...
            public string SQLCommand { get { return (_finalised && _numValues > 0) ? _sb.ToString() : ";"; } }
            public int NumValues { get { return _numValues; } }

            public void Init(IWriteable w)
            {
                _sb.Remove(0, _sb.Length);
                _sb.AppendFormat("INSERT INTO {0} ({1}) VALUES ", w.TableName, w.FieldList);
                _numValues = 0;
                _finalised = false;
            }
